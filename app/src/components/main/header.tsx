      ...
      <div className="bg-primary text-secondary shadow-lg">
        <div className="max-w-7xl mx-auto px-4 md:px-6 py-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-3 md:gap-4">
            <div className="col-span-2 md:col-span-1 bg-white/10 backdrop-blur-sm rounded-lg p-3 text-center my-auto">
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-3 text-center my-auto">
